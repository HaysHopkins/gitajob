...
module Gitajob
  class CLI < Thor
    ...
    method_option :repeat, :aliases => "-r", :desc => "Specify number of times to probe", :type => :numeric, :default => 5, :enum => (1..100).to_a
    method_option :frequency, :aliases => "-f", :desc => "Specify probing frequency in seconds", :type => :numeric, :default => 7, :enum => [5, 10, 15, 30, 60]
